      ...
      <div className="showcase__stage">
        ...
        <article className="showcase__hero" key={idx} data-dir={dir}>
          <div className="showcase__info">
            ...
            {p.repo && (
              <a
                className="showcase__repo showcase__rise"
                style={{ animationDelay: '0.36s' }}
                href={p.repo}
                target="_blank"
                rel="noreferrer noopener"
                aria-label={`View ${p.title} source on GitHub (opens in a new tab)`}
              >
                <svg className="showcase__repo-ico" viewBox="0 0 16 16" width="16" height="16" aria-hidden focusable="false">
                ...
                <span className="showcase__repo-arrow" aria-hidden>↗</span>
              </a>
            )}
          </div>
